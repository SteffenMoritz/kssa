...
#' Function to split TS
  ...
  if(start.method == 'all'){ #' Define 'all' statement
  ...
  set.seed(seed); imputation <- eval(parse(text = df_of_methods$formulas_x_ts[df_of_methods$methods == best_result$actual.method]))
